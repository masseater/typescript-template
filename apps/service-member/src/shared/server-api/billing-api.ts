...
import { PaidPlanRequired, findSubscription, planOf } from "@repo/db/billing";
...
const unreadable = { message: "通知を読み取れませんでした。", status: httpStatus.badRequest };
const failures = {
  ...unavailable,
  ...paidFailures,
  PaidAlready: { message: "すでに有料プランを契約しています。", status: httpStatus.conflict },
