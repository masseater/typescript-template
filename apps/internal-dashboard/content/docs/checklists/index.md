...
事業の案が出てから畳むまでを時間の順に区切り、その時点で決めることと、決めたことを書く場所を並べます。開発は段階ではなく「作っているとき」の中の作業として扱い、事業や運用や広報と同じ並びに置きます。
...
リリースは一度では終わりません。機能を足すたびに 2 から 4 までを回し、公開した後はずっと「変更や問題が起きたとき」と「定期的に見るとき」が並走します。

## 書く場所

決めたことは、種類ごとに次の場所に書きます。同じことを 2 か所に書かず、片方からもう片方へリンクします。
...
各ページの冒頭に、始めるきっかけと終わる条件を置きます。各項目は、何を決めるかと、書く場所を並べます。手順はここに書かず、手順を持つ文書へリンクします。
