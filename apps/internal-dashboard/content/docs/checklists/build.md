...
- 仕様を決めたら、その時点で wiki の該当ページを直します。決めた経緯はコミットログに書きます。
- 決めた頻度で進み具合を報告します。想定する利用者に staging で途中のものを触ってもらい、反応を issue に残します。
- リスクの一覧の対応を実行します。新しく見つかったものは、リスク用のラベルを付けた issue にします。
