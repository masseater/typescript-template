...
function ConfirmDialogPopup({
  ...
  return (
    <AlertDialogPrimitive.Popup
      ...
      className="fixed top-1/2 left-1/2 z-50 flex w-full max-w-md -translate-x-1/2 -translate-y-1/2 flex-col gap-4 rounded-lg border border-border bg-card p-6 text-card-foreground shadow-xl outline-none"
    >
