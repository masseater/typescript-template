...
describe("email change", () => {
  ...
  describe("a member who just verified the authenticator app", () => {
    const it = authTest
      ...
      .extend("verificationPath", async ({ auth }) =>
        runWith(auth, () =>
      ...
      .extend("verificationTokenPresent", async ({ auth }) =>
        runWith(auth, () =>
