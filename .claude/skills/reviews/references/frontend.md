...
見た目・UI 部品・レイアウトを触る前にルートの `DESIGN.md` を読むことは `AGENTS.md` が決めている。React の書き方とフックの選び方は `.claude/skills/modern-react-guidance/SKILL.md`、非同期の瀑布は `.claude/skills/react-best-practices/SKILL.md`。
