...
1. `references/interview.md` の問いで、何をプレゼンしたいのかをユーザーにインタビューする。1 回に 1 問だけ聞き、覚えて帰ってほしい 1 文が決まるまで次へ進まない。
2. `references/structures.md` から話の型と本論の並べ方を 1 つずつ選ぶ。
3. `references/section-map.md` の基準でセクション表を作り、ユーザーに見せて直してもらう。直しが返るまで台本とスライドに進まない。
...
返答: 覚えて帰ってほしい 1 文、選んだ型、セクション数と時間配分、`references/checklist.md` で落ちて直した項目。
