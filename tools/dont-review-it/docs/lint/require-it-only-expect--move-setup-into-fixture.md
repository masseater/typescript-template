...
- Options: yes
- Bundle: `testing`
- Source: [`require-it-only-expect--move-setup-into-fixture.ts`](../../src/features/dont-review-it/lint/oxlint/rules/testing/require-it-only-expect--move-setup-into-fixture.ts)
