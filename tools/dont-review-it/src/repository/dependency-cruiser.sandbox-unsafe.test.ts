...
const detected: readonly Case[] = [
  [
    "no-circular",
    {
      "libs/auth/src/cycle-a.ts": 'export * from "./cycle-b.ts";\n',
      "libs/auth/src/cycle-b.ts": 'export * from "./cycle-a.ts";\n',
    },
  ],
  [
    "no-unresolvable",
...
const accepted: readonly Case[] = [
  ...
  [
    "no-wiki-to-database",
    {
      "apps/internal-dashboard/src/index.ts": 'export * from "@repo/db/dashboard-literals";\n',
    },
  ],
  [
    "no-browser-to-server",
