    ...
    buildCatalog([
      {
        ...
        declarationPath: "tools/ai-native/src/throttle/signals.ts",
        fingerprint: fingerprintValues(engineValues),
        importRoutes: [
          {
            exportName: "ENGINE_NAMES",
            resolvedSourcePaths: ["tools/ai-native/src/throttle/signals.ts"],
      ...
      valid: [
        {
          ...
          cwd: repositoryRoot,
          filename: join(repositoryRoot, "tools/ai-native/src/direct-engine-schema.ts"),
        },
        {
          ...
          cwd: repositoryRoot,
          filename: join(repositoryRoot, "tools/ai-native/src/shadow-engine-schema.ts"),
        },
      ],
      invalid: [
        {
