...
writeFileSync(
  ...
  '{ "extends": "@template/dont-review-it/tsconfig/app.json" }\n',
);
...
writeFileSync(
  ...
  '{ "extends": ["./local.json", "@template/dont-review-it/tsconfig/library.json"] }\n',
);
...
writeFileSync(
  ...
  '{\n  /* Bundler mode */\n  "extends": "@template/dont-review-it/tsconfig/app.json", // preset\n}\n',
);
...
writeFileSync(
  ...
  '{ "extends": "@template/dont-review-it/tsconfig/base.json" }\n',
);
