...
const FIXTURE_IMPORT = `import { standardIoTest } from "@template/dont-review-it/vitest";`;
...
it("pins stderr", ({ stderr }) => {
  expect(stderr.text).toMatchInlineSnapshot();
      ...
      },
      {
        ...
        code: `import { standardIoTest as ioTest } from "@template/dont-review-it/vitest";
