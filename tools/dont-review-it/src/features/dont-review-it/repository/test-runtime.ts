...
const browserOrNodeOnly =
  /\/libs\/(?:ui|auth-ui)\/|\/libs\/observability\/src\/features\/observability\/browser\.ts$|\/libs\/runtime\/src\/features\/runtime\/client\.ts$|\/libs\/db\/src\/features\/db\/remote[^/]*\.ts$|\/libs\/db-local\/src\/features\/db-local\/testing-node[^/]*\.ts$/u;
