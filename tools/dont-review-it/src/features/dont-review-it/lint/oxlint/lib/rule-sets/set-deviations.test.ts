...
const FAILURE_ROUTING_RULES = ["no-silent-catch--rethrow-or-handle"];
      ...
      expect(deviations).toStrictEqual([
        ...
        },
        {
          ...
          data: {
            ...
            namedRule: "no-promise-chain--use-async-await",
            missingRules:
              "no-silent-catch--rethrow-or-handle, no-floating-promise--await-the-result",
            holes:
              "a catch clause that records the failure nowhere passes; a promise nothing waits for drops its failure on the floor",
            scope: "",
          },
        },
      ]);
      ...
      expect(deviations).toStrictEqual([
        {
          property: {
            ...
            value: { type: "Literal", value: "warn", raw: '"warn"', start: 543, end: 549 },
            method: false,
            shorthand: false,
            computed: false,
            optional: false,
