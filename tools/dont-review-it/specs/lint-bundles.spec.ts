...
import { LINT_BUNDLE, type LintBundleSelection } from "../src/features/dont-review-it/configs/bundles/bundle-names.ts";
...
const RULES_DIRECTORY = join(import.meta.dirname, "../src/features/dont-review-it/lint/oxlint/rules");
