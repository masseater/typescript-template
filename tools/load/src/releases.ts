...
const releases: ReadonlyMap<string, Release> = new Map([
  release("darwin-arm64", {
    archive: "macos-arm64.zip",
    digest: "37a028506bf13578de66c906296803775df28cc2504b1a8c5d786b2803e757c7",
    member: "macos-arm64",
  }),
  release("darwin-x64", {
    archive: "macos-amd64.zip",
    digest: "45a08590511c8a6a9c6331645e60c41624924e848e29472e87c60ac956d50372",
    member: "macos-amd64",
  }),
  release("linux-arm64", {
    archive: "linux-arm64.tar.gz",
    digest: "4ecd64cadcc792402d16293836115480419c4447c032858f564852d98f1bf54c",
    member: "linux-arm64",
  }),
  release("linux-x64", {
    archive: "linux-amd64.tar.gz",
    digest: "b5a8003c86f35f5cd5ceef1490312c48e587696c94d998cefc6d7b3b4cb1597d",
    member: "linux-amd64",
  }),
]);
