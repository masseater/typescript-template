...
# @repo/lint-rule-authoring — author a lint rule
...
```
@repo/lint-rule-authoring         createWorkspaceLintRule, testLintRule, LINT_SEVERITY,
                                 measureStage, lintRuleIndexProblems, lintRuleDocProblems,
                                 firstToken, matchesGlobSegment, oxlint
@repo/lint-rule-authoring/plugin  the oxlint jsPlugins entry holding this package's own rules
