...
const prefixPath = (reference: D1Reference, key: string): D1Reference => {
...
const d1Property = (references: readonly D1Reference[], key: string): D1Reference[] => {
...
const d1NamedType = (source: string, name: string): D1Reference[] => {
  const workerKind =
