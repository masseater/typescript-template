...
const findSpoolRoot = (currentDir: string, fallbackDir: string): Effect.Effect<string> =>
...
export const defaultSpoolRoot = (startDir: string = process.cwd()): Effect.Effect<string> =>
